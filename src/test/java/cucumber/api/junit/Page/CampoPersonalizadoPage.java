...
public class CampoPersonalizadoPage extends PaginaInicialPage {
	...
	// editar campo
	By campoPersonalizadoComum = (By.xpath("//a[contains(@href, 'manage_custom_field_edit_page.php?field_id=14')]"));
	...
	// excluir o vinculo
	By excluirVinculoCampo = (By.xpath("//a[contains(@href, 'manage_custom_field_edit_page.php?field_id=14')]"));
	...
	public void preencherNomeCampo(String campoPersonalizado) {
		WebElement nomeCampoPersonalizadoField = wait
				.until(ExpectedConditions.visibilityOf(driver.findElement(nomeCampoPersonalizado)));
	...
	public void selecionarCampoEdicao() {
		WebElement editarCampoPersonalizado = wait
				.until(ExpectedConditions.visibilityOf(driver.findElement(campoPersonalizadoComum)));
		editarCampoPersonalizado.click();
	}

	public void preenchoAcessoLeitura(String acessoDeLeitura) {
		WebElement editarAcessoLeitura = wait
				.until(ExpectedConditions.visibilityOf(driver.findElement(alterarAcessoLeitura)));
	...
	public void concluirEdicaoCampo() {
		WebElement buttonAtualizarCampo = wait
				.until(ExpectedConditions.visibilityOf(driver.findElement(atualizarCampoPersonalizado)));
		buttonAtualizarCampo.click();
	}

	// vincular campo ao projeto
	public void selecionarTarefaVincular() {
		WebElement tarefaParaVincular = wait
				.until(ExpectedConditions.visibilityOf(driver.findElement(campoPersonalizadoComum)));
		tarefaParaVincular.click();
	}

	public void vincularCampoProjeto() {
		WebElement selecionarVincularCampo = wait
				.until(ExpectedConditions.visibilityOf(driver.findElement(campoParaVincular)));
	...
	public void selecionarCampoExcluir() {
		WebElement campoExcluirVinculo = wait
				.until(ExpectedConditions.visibilityOf(driver.findElement(excluirVinculoCampo)));
		campoExcluirVinculo.click();
	}

	public void apagarCampoPersonalizado() {
		WebElement apagarCampoPersonalizadoVinculo = wait
				.until(ExpectedConditions.visibilityOf(driver.findElement(apagarVinculoCampoPersonalizado)));
