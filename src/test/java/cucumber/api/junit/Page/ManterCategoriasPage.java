...
public class ManterCategoriasPage extends PaginaInicialPage {

	public ManterCategoriasPage(WebDriver driver) {
		super(driver);
	...
	By categoriaField = (By.xpath("//*[@id=\"categories\"]/div/div[2]/form/div/input[3]"));
	...
	public void informarNomeCategoria(String categoria) {
		WebElement nomeCategoriaField = wait.until(ExpectedConditions.visibilityOf(driver.findElement(categoriaField)));
		nomeCategoriaField.sendKeys(categoria);
	}
	...
	public void adicionarCategoriaVazio() {
		WebElement adicionarVazioCategoriaButton = wait
				.until(ExpectedConditions.visibilityOf(driver.findElement(adicionarCategoria)));
		adicionarVazioCategoriaButton.click();
	}

	public void validarMensagemTela() {
		WebElement validarMensagemVazio = wait.until(ExpectedConditions.visibilityOf(driver.findElement(validarTexto)));
		validarMensagemVazio.getText();
	}

	// excluir categoria
	public void excluirCategoriaSelecionar() {
		WebElement selecionarCategoria = wait
				.until(ExpectedConditions.visibilityOf(driver.findElement(selecionarCategoriaExclusao)));
